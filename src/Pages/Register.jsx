      ...
      <div className="hero min-h-screen">
        <div className="hero-content flex-col">
          <div className="text-center lg:text-left">
            <h1 className="text-3xl font-bold text-black">Register now!</h1>
          </div>
          <div className="card w-full max-w-sm shrink-0 shadow-2xl bg-black/15 backdrop-blur-lg border rounded-2xl border-purple-500/30 ">
              ...
              <form onSubmit={handleRegister}>
                <fieldset className="fieldset">
                  ...
                  <input
                    name="name"
                    type="text"
                    className="input bg-transparent border border-gray-600 text-black placeholder-gray-400 rounded-lg"
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="cursor-pointer absolute top-3 right-5 text-black"
                    >
                  ...
                  <button
                    ...
                    className="btn rounded-full bg-white border-[#e5e5e5] w-full mt-2 flex items-center justify-center gap-2"
                  >
                    <svg
